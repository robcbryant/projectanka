...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.flagged_for_deletion'
        db.add_column(u'maqluengine_form', 'flagged_for_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FormRecordReferenceValue.flagged_for_deletion'
        db.add_column(u'maqluengine_formrecordreferencevalue', 'flagged_for_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FormRecordAttributeValue.flagged_for_deletion'
        db.add_column(u'maqluengine_formrecordattributevalue', 'flagged_for_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FormRecordReferenceType.flagged_for_deletion'
        db.add_column(u'maqluengine_formrecordreferencetype', 'flagged_for_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FormType.flagged_for_deletion'
        db.add_column(u'maqluengine_formtype', 'flagged_for_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FormRecordAttributeType.flagged_for_deletion'
        db.add_column(u'maqluengine_formrecordattributetype', 'flagged_for_deletion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.flagged_for_deletion'
        db.delete_column(u'maqluengine_form', 'flagged_for_deletion')

        # Deleting field 'FormRecordReferenceValue.flagged_for_deletion'
        db.delete_column(u'maqluengine_formrecordreferencevalue', 'flagged_for_deletion')

        # Deleting field 'FormRecordAttributeValue.flagged_for_deletion'
        db.delete_column(u'maqluengine_formrecordattributevalue', 'flagged_for_deletion')

        # Deleting field 'FormRecordReferenceType.flagged_for_deletion'
        db.delete_column(u'maqluengine_formrecordreferencetype', 'flagged_for_deletion')

        # Deleting field 'FormType.flagged_for_deletion'
        db.delete_column(u'maqluengine_formtype', 'flagged_for_deletion')

        # Deleting field 'FormRecordAttributeType.flagged_for_deletion'
        db.delete_column(u'maqluengine_formrecordattributetype', 'flagged_for_deletion')
    ...
    models = {
        ...
        u'maqluengine.form': {
            ...
            'flagged_for_deletion': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'maqluengine.formproject': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'uri_download': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'uri_img': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'uri_thumbnail': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'uri_upload': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'uri_upload_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'maqluengine.formtype': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'file_extension': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'flagged_for_deletion': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'uri_prefix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
