...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Permissions.custom_templates'
        db.add_column(u'maqluengine_permissions', 'custom_templates',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Permissions.saved_queries'
        db.add_column(u'maqluengine_permissions', 'saved_queries',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Permissions.custom_templates'
        db.delete_column(u'maqluengine_permissions', 'custom_templates')

        # Deleting field 'Permissions.saved_queries'
        db.delete_column(u'maqluengine_permissions', 'saved_queries')
    ...
    models = {
        ...
        u'maqluengine.permissions': {
            ...
            'custom_templates': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'saved_queries': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
