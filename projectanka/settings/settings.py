...
# 'SHOW_TOOLBAR_CALLBACK': 'projectanka.settings.maqluengine.custom_show_toolbar',
# 'INSERT_BEFORE': '</body>',
...
WSGI_APPLICATION = 'projectanka.wsgi.application'
...
#HAS_SYSLOG = True
#SYSLOG_TAG = ""  # Make this unique to your project.
