...
function checkUserName(){
    ...
    function checkName($nameElement) {                    
            ...
            $.ajax({ 
             url   : 'http://67.205.135.223/admin/username_taken/',
             type  : "POST",
...
function submitUserChangesToServer(){
    ...
    if (userChangeList != '{"userlist":['){
        ...
        $.ajax({ 
             url   : 'http://67.205.135.223/admin/modify_project_user/',
             type  : "POST",
             data  : postJSON, // data to be submitted
             success : function(returnedQuery)
             {
...
function refreshUserPanel(){
          $.ajax({ 
             url   : 'http://67.205.135.223/admin/get_user_list/',
             type  : "POST",
             data  : postJSON, // data to be submitted
             success : function(returnedQuery)
             {
...
function checkAllRequiredFieldsHaveInput(){
 ...
 $('#project-form').submit( function(e){
        ...
        $.ajax({ 
             url   : 'http://67.205.135.223/admin/save_project_changes/',
             type  : "POST",
