...
$("#search-form").find('form.query-engine').submit(function(e){
    ...
    $.ajax({ 
         url   : 'http://67.205.135.223/admin/run_query_engine/',
         type  : "POST",
...
function addDeepSearchListener() {
    ...
    if (rtypeCode[0] == 'FRRT'){
       ...
       //Send and AJAX Request
        $.ajax({ 
                 url   : "http://67.205.135.223/admin/get_rtype_list/",
                 type  : "POST",
...
$(function() {
    ...
    */
    ...
    function update_progress_info() {
        ...
        $.getJSON('http://67.205.135.223/admin/check_progress_query/', {'uuid': progress_uuid}, function(data, status){
